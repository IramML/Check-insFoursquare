...
class LikesFragment : Fragment() {
    ...
    companion object {
        ...
        var venuesList:ArrayList<Venue>?=null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        view0=inflater.inflate(R.layout.fragment_likes, container, false)
        return view0
    }
    ...
    private fun initRecyclerView(){
        list =activity?.findViewById(R.id.rvVenuesLike) as RecyclerView
        list?.setHasFixedSize(true)
        layoutManager= LinearLayoutManager(view0?.context)
        list?.layoutManager=layoutManager
        if(appCompatActivity!=null)
            implementRecyclerView(venuesList!!, appCompatActivity!!)
    }
}
